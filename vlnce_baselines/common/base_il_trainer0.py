...
class BaseVLNCETrainer(BaseILTrainer):
    ...
    def _initialize_policy(
        ...
        if load_from_ckpt:
            ...
            print("init___policy:ckpt_path::::{}".format(ckpt_path))
            ckpt_dict = self.load_checkpoint(ckpt_path, map_location="cpu")
            print("type:::{}".format(type(ckpt_dict)))
            # with open(
            #     '/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/ckpt_dict.txt',
            #     'w') as f:
            #     f.write(str(ckpt_dict))

            self.policy.load_state_dict(ckpt_dict["state_dict"])
            if config.IL.is_requeue:   # false
    ...
    def _eval_checkpoint(
        ...
        print("EEEEEEEEEEEEEEEEVVVVVVVVVVVVVVVVVVV")
        config = self.config.clone()
        print("save config file==========================================")
        # with open('/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/eval_config.txt', 'w') as f:
        #     f.write(str(config))
        ...
        split = config.EVAL.SPLIT    # val_unseen???
        ...
        print("====================ENV===========================")
        print("ob::::{}".format(observation_space))
        print("ac::::{}".format(action_space))
        ...
        print("obbbb")
        with open(
            '/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/mylog/ob1.txt',
            'w') as f:
        ...
        with open(
            '/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/mylog/ob2.txt',
            'w') as f:
            f.write(str(observations))
        batch = batch_obs(observations, self.device)
        print("batch------")
        with open(
            '/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/mylog/batch1.txt',
            'w') as f:
            f.write(str(batch))
        batch = apply_obs_transforms_batch(batch, self.obs_transforms)
        for name, t in batch.items():
            print("name:{}, size:{}".format(name, t.shape))
        with open(
            '/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/mylog/batch2.txt',
            'w') as f:
            f.write(str(batch))
        ...
        # print("action_shape:::{}".format(prev_actions.shape()))
        with open(
            '/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/mylog/pre_action.txt',
            'w') as f:
            f.write(str(prev_actions))
        ...
        print(">>>>>>>>>>>>>>>>>>>>>>start@@@@@@@>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
        print("envs.num_envs:::{}".format(envs.num_envs))
        print("state_episode:::{}".format(stats_episodes))
        print("num_eps:::{}".format(num_eps))

        while envs.num_envs > 0 and len(stats_episodes) < num_eps:
            print("num_envs:::{}".format(envs.num_envs))
            print("state_ep:::{}".format(stats_episodes))
            print("len(se):::{}".format(len(stats_episodes)))
            print("num_eps:::{}".format(num_eps))
            current_episodes = envs.current_episodes()
            # print("current_episodes:::{}".format(current_episodes))
            with open(
                '/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/mylog1/currnt_episode.txt',
                'w') as f:
                f.write(str(current_episodes))
            with open(
                '/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/mylog1/batchee.txt',
                'w') as f:
                f.write(str(batch))
            with open(
                '/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/mylog1/rnn_statesee.txt',
                'w') as f:
                f.write(str(rnn_states))
            with open(
                '/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/mylog1/actionee.txt',
                'w') as f:
                f.write(str(prev_actions))
            with open(
                '/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/mylog1/not_done_mask.txt',
                'w') as f:
                f.write(str(not_done_masks))
            with torch.no_grad():
                ...
                with open(
                    '/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/mylog1/actionsee.txt',
                    'w') as f:
                    f.write(str(actions))
                with open(
                    '/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/mylog1/rnnsoo.txt',
                    'w') as f:
                    f.write(str(rnn_states))
            ...
            with open(
                '/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/mylog1/outputoo.txt',
                'w') as f:
                f.write(str(outputs))
            observations, _, dones, infos = [list(x) for x in zip(*outputs)]
            with open(
                '/home/x/VLNCE/VLN-CE/data/checkpoints/cma_test/mylog1/oboo.txt',
                'w') as f:
                f.write(str(observations))
            ...
            print("oneneeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee")
            # reset envs and observations if necessary
            print("loop================{}======================".format(envs.num_envs))
